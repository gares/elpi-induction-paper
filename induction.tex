...
\lstset{backgroundcolor=\color[rgb]{0.90,0.90,0.90}}
...
\supplement{Source code of the Coq package: \url{https://github.com/LPCIC/coq-elpi}}
%% Keywords
...
package\footnote{See the supplementary material URL for the
...
% \lstinline+(forall x, is_A x)+ can be proved not only for
% trivial \lstinline+is_A+. In particular, during induction
